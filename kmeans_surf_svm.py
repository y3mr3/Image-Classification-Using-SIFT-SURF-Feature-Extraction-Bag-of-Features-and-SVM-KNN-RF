# -*- coding: utf-8 -*-
"""Kmeans_surf_Svm.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fpxA7DKFFAYbCibe4RG7rr2MX1f0Ibha
"""
...
"""Bu Fonksiyon Train Data Setine SURF Uygularak Elde Edilen Keypoint ve Descriptorleri K-means'le Kümeleyerek Model Databesini Oluştur."""
...
def read_and_clusterize(df, num_cluster):
    ...
    kmeans = MiniBatchKMeans(n_clusters=num_cluster, random_state=0).fit(surf_keypoints)
...
save_model('clusterize_model_n_clusters_200_surf')
